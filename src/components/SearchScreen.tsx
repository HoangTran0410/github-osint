      ...
      <div className="layout-content-container flex flex-col max-w-2xl w-full text-center items-center">
        ...
        <div className="w-full max-w-lg px-4 py-3">
          <div className="flex flex-col sm:flex-row gap-3 w-full">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-primary text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors disabled:opacity-70"
            >
        ...
        <div className="mt-8 text-center w-full">
          ...
          <div className="flex justify-center items-center gap-4 flex-wrap">
            <button onClick={() => onSearch('linus-torvalds')} className="flex items-center gap-2 bg-slate-200 dark:bg-white/5 px-3 py-1.5 rounded-full hover:bg-slate-300 dark:hover:bg-white/10 transition-colors">
              <img className="w-6 h-6 rounded-full" src="https://avatars.githubusercontent.com/u/1024025?v=4" alt="Linus Torvalds" />
              <span className="text-slate-700 dark:text-white/80 text-sm">linus-torvalds</span>
            </button>
            <button onClick={() => onSearch('yyx990803')} className="flex items-center gap-2 bg-slate-200 dark:bg-white/5 px-3 py-1.5 rounded-full hover:bg-slate-300 dark:hover:bg-white/10 transition-colors">
              <img className="w-6 h-6 rounded-full" src="https://avatars.githubusercontent.com/u/499550?v=4" alt="Evan You" />
              <span className="text-slate-700 dark:text-white/80 text-sm">yyx990803</span>
            </button>
            <button onClick={() => onSearch('taylorotwell')} className="flex items-center gap-2 bg-slate-200 dark:bg-white/5 px-3 py-1.5 rounded-full hover:bg-slate-300 dark:hover:bg-white/10 transition-colors">
              <img className="w-6 h-6 rounded-full" src="https://avatars.githubusercontent.com/u/463230?v=4" alt="Taylor Otwell" />
